...
|`banjo`|Hay Bale|
|`pling`|Glowstone|
|`trumpet`|Block of Copper|
|`exposed trumpet`|Exposed Copper|
|`weathered trumpet`|Weathered Copper|
|`oxidized trumpet`|Oxidized Copper|
...
8. After it finishes, move the .zip folder to the datapack folder in the world you're using it in.# WirelessNBS
Turns a .nbs file into a Wireless Noteblock Piece via datapack.
